...
└── treecipe/src/
    ...
    │   ├── RecipeCockpitService.ts           # Owns the Recipe Cockpit webview panel; pure shell/CSP/nonce builders and a pure ready/ack message router
    │   └── tests/
